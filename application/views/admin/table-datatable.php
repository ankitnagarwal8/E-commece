...
<head>
    ...
    <!-- Custom Stylesheet -->
    <link href="http://localhost/ecommerce/Assets/Admin/plugins/tables/css/datatable/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<?php include('header.php'); ?>
    ...
    ***********************************-->
    ...
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/tables/js/jquery.dataTables.min.js"></script>
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/tables/js/datatable/dataTables.bootstrap4.min.js"></script>
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/tables/js/datatable-init/datatable-basic.min.js"></script>
