...
<head>
    ...
    <!-- Pignose Calender -->
    <link href="http://localhost/ecommerce/Assets/Admin/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="http://localhost/ecommerce/Assets/Admin/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="http://localhost/ecommerce/Assets/Admin/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
...
<body>
    ...
    ***********************************-->
    ...
    <!-- Chartjs -->
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/chart.js/Chart.bundle.min.js"></script>
    <!-- Circle progress -->
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/circle-progress/circle-progress.min.js"></script>
    <!-- Datamap -->
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/d3v3/index.js"></script>
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/topojson/topojson.min.js"></script>
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/datamaps/datamaps.world.min.js"></script>
    <!-- Morrisjs -->
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/raphael/raphael.min.js"></script>
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/morris/morris.min.js"></script>
    <!-- Pignose Calender -->
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/moment/moment.min.js"></script>
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/pg-calendar/js/pignose.calendar.min.js"></script>
    <!-- ChartistJS -->
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/chartist/js/chartist.min.js"></script>
    <script src="http://localhost/ecommerce/Assets/Admin/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>
